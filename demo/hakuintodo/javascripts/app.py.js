...
var __Task_say = function(args, kwargs) {
var signature, arguments;
signature = {"kwargs": {}, "args": create_array("self")};
arguments = get_arguments(signature, args, kwargs);
var self = arguments['self'];
...
__kwargs_38 = {};
console.log("clicked: " + get_attribute(get_attribute(get_attribute(self, "model"), "to_string"), "__call__")(__args_38, __kwargs_38));
var __args_39, __kwargs_39;
__args_39 = create_array();
__kwargs_39 = {};
get_attribute(get_attribute(get_attribute(self, "model"), "destroy"), "__call__")(__args_39, __kwargs_39);
var __args_40, __kwargs_40;
__args_40 = create_array();
__kwargs_40 = {};
get_attribute(get_attribute(self, "release"), "__call__")(__args_40, __kwargs_40);
}

__Task_attrs.say = __Task_say;
...
__args_41 = create_array(self);
__kwargs_41 = {};
get_attribute(get_attribute(Collection, "__init__"), "__call__")(__args_41, __kwargs_41);
var __args_42, __kwargs_42;
__args_42 = create_array("remove", get_attribute(self, "rsay"));
__kwargs_42 = {};
get_attribute(get_attribute(e, "bind"), "__call__")(__args_42, __kwargs_42);
}
...
__kwargs_44 = {};
console.log("removed: " + get_attribute(get_attribute(get_attribute(get_attribute(model, "pop"), "__call__")(__args_44, __kwargs_44), "to_string"), "__call__")(__args_43, __kwargs_43));
var __iterator__, m;
__iterator__ = get_attribute(get_attribute(get_attribute(self, "models"), "__iter__"), "__call__")(create_array(), {});
try {
m = get_attribute(__iterator__, "next")(create_array(), {});
...
__kwargs_45 = {};
console.log(get_attribute(get_attribute(m, "to_string"), "__call__")(__args_45, __kwargs_45));
undefined;
m = get_attribute(__iterator__, "next")(create_array(), {});
}
}
...
__args_46 = create_array(self, "div", el);
__kwargs_46 = {};
get_attribute(get_attribute(Controller, "__init__"), "__call__")(__args_46, __kwargs_46);
set_attribute(self, "collection", collection);
var __args_47, __kwargs_47;
__args_47 = create_array("#newtask");
__kwargs_47 = {};
button = get_attribute(J, "__call__")(__args_47, __kwargs_47);
var __args_48, __kwargs_48;
__args_48 = create_array("click", false, get_attribute(self, "create"));
__kwargs_48 = {};
get_attribute(get_attribute(button, "bind"), "__call__")(__args_48, __kwargs_48);
var __args_49, __kwargs_49;
__args_49 = create_array("add", get_attribute(self, "render"));
__kwargs_49 = {};
get_attribute(get_attribute(e, "bind"), "__call__")(__args_49, __kwargs_49);
}
...
__args_50 = create_array("#taskinput");
__kwargs_50 = {};
j = get_attribute(get_attribute(J, "__call__")(__args_50, __kwargs_50), "j");
name = j.val();
if(name != "") {
var __args_51, __kwargs_51;
__args_51 = create_array(name);
__kwargs_51 = {};
var __args_52, __kwargs_52;
__args_52 = create_array(get_attribute(TaskModel, "__call__")(__args_51, __kwargs_51));
__kwargs_52 = {};
get_attribute(get_attribute(get_attribute(self, "collection"), "add"), "__call__")(__args_52, __kwargs_52);
var __args_53, __kwargs_53;
__args_53 = create_array("#taskinput");
__kwargs_53 = {};
j = get_attribute(get_attribute(J, "__call__")(__args_53, __kwargs_53), "j");
empty_text = "";
j.val(empty_text);
}
...
__args_54 = create_array(m);
__kwargs_54 = {};
task = get_attribute(Task, "__call__")(__args_54, __kwargs_54);
var __args_55, __kwargs_55;
__args_55 = create_array();
__kwargs_55 = {};
var __args_56, __kwargs_56;
__args_56 = create_array(get_attribute(get_attribute(task, "html"), "__call__")(__args_55, __kwargs_55));
__kwargs_56 = {};
get_attribute(get_attribute(get_attribute(self, "el"), "append"), "__call__")(__args_56, __kwargs_56);
undefined;
undefined;
m = get_attribute(__iterator__, "next")(create_array(), {});
}
...
__args_57 = create_array();
__kwargs_57 = {};
var __args_58, __kwargs_58;
__args_58 = create_array("#items", get_attribute(TaskList, "__call__")(__args_57, __kwargs_57));
__kwargs_58 = {};
get_attribute(TaskApp, "__call__")(__args_58, __kwargs_58);
