...
var __J_delegate = function(args, kwargs) {
var signature, arguments;
signature = {"kwargs": {}, "args": create_array("self", "selector", "eventName", "handler")};
arguments = get_arguments(signature, args, kwargs);
var self = arguments['self'];
var selector = arguments['selector'];
...
var handler = arguments['handler'];
j = get_attribute(self, "j");
o = j.delegate(selector, eventName, adapt_arguments(handler));
...
__J_attrs.delegate = __J_delegate;
...
__args_77 = create_array(o);
__kwargs_77 = {};
return get_attribute(J, "__call__")(__args_77, __kwargs_77);
}
